...
class LoginButton extends Component {
    ...
    render() {
        ...
        return (
            <a href={"https://www.ravelry.com/oauth2/auth?response_type=code&redirect_uri=" + process.env.REACT_APP_ROOT_URL + "/session/ravelry/callback&client_id=" + process.env.REACT_APP_RAVELRY_CLIENT_ID + "&state=1234abcd"}
